...
def read_yaml(
    ...
    **kwargs,
    ...
    from hdt.preprocessing import extended_importer as yaml_importer
    ...
    # Patch list values in the 'data' column that the importer drops to None.
    # The pm4py yaml importer only stores scalar values; list-valued attributes
    # are silently set to None in the child dict's 'value' key.
    # We re-read the raw YAML once and inject the real list values.
